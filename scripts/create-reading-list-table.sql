-- First, check if reading_list_full table exists and add missing columns
DO $$ 
BEGIN
...
DROP POLICY IF EXISTS "Users can manage their own reading list" ON reading_list_full;
DROP POLICY IF EXISTS "Users can view their own reading list" ON reading_list_full;
...
-- Migration: For existing reading_list_full entries without user_id, 
